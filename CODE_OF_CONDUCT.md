...
requests, discussions, chat) and also when an individual is officially
representing the community in public spaces.

## Enforcement

Instances of abusive, harassing, or otherwise unacceptable behaviour may be
reported to the project maintainers by opening a private discussion on the
repository or via direct message to a maintainer. All complaints will be
